...
// ─── PERSONALIDADES — datos completos con todos los campos ───────────────────
const PERSONALIDADES = [
  {
    name: 'José Serrano Serna', flag: '🇪🇸',
    org: 'Awaq ONGD',
    rol: 'CEO-Presidente Awaq ONGD · Promotor y Sponsor del 2ICEO-LATAM',
    ...
    li: 'https://www.linkedin.com/in/jsserna5575/', liType: 'linkedin' as const,
    img: '/icons/jose_serrano.svg',
  },
  {
    name: 'Luis Alfonso Aguirre', flag: '🇨🇴',
    org: 'PMI® Colombia',
    rol: 'Program Manager PMI® Colombia · Promotor y Sponsor del 2ICEO-LATAM',
    ponencia: 'Taller: Proyectos que dejan huella – "Formulación de Proyectos Sociales Sostenibles".',
    li: 'https://www.linkedin.com/in/luis-alfonso-aguirre-montealegre-0770a91a/', liType: 'linkedin' as const,
    img: '/icons/luis_alfonso.svg',
  },
  {
    name: 'Begoña de la Hera', flag: '🇪🇸',
    org: 'Awaq ONGD',
    rol: 'Directora Programa TEDI Awaq ONGD · Directora Proyecto ABT 2025-2028',
    ponencia: 'Presentación resultados parciales del proyecto ABT 2025 – Hoja de Ruta 2026-2027.',
    li: 'https://www.linkedin.com/in/bego%C3%B1a-de-la-hera-25ba801a/', liType: 'linkedin' as const,
    img: '/icons/begona_hera.svg',
  },
  {
    name: 'Rolando Evelio Pérez Versón', flag: '🇲🇽',
    org: 'Tecnológico de Monterrey',
    rol: 'Profesor Planta · Director Técnico ABT 2025-2028',
    ponencia: 'Presentación componentes tecnológicos IA, Programa ABT.',
    li: 'https://www.linkedin.com/in/rolando-evelio-p%C3%A9rez-vers%C3%B3n-4137a8264/', liType: 'linkedin' as const,
    img: '/icons/rolando_evelio.jpg',
  },
  {
    name: 'Hno. Camilo Andrés Aguilar Gómez', flag: '🇨🇴',
    org: 'Universidad de La Salle',
    rol: 'Coordinador Universidad de La Salle · Coordinador de Utopía',
    ponencia: 'UTOPÍA: Un horizonte educativo para el cuidado, la sostenibilidad y la ecología integra.',
    li: 'https://www.linkedin.com/in/camilo-andr%C3%A9s-aguilar-g%C3%B3mez-437a32258/', liType: 'linkedin' as const,
    img: '/images/ponentes_Camilo_Andrés_Aguilar.jpeg',
  },
  {
    name: 'Mtro. Gustavo Herrera Caballero', flag: '🇨🇴',
    org: 'SELA',
    rol: 'Coordinador SELA · Coordinador Desarrollo Social',
    ponencia: 'La experiencia del SELA en la implementación de la Agenda 2030.',
    li: 'https://www.linkedin.com/in/gustavo-herrera-3528a979/', liType: 'linkedin' as const,
    img: '/images/ponentes_Gustavo_Herrera.jpeg',
  },
  {
    name: 'Liza Rodríguez Galvis', flag: '🇨🇴',
    ...
    li: 'https://www.instagram.com/lizarodriguez18?igsh=dHYzaml4NG02bGoy', liType: 'instagram' as const,
    img: '/images/ponentes_Liza_Rodriguez_Galvis.jpeg',
  },
  {
    name: 'Nasly Fernanda Gonzales Vidales', flag: '🇨🇴',
    ...
    li: 'https://www.linkedin.com/in/nasly-fernanda-vidales-gonz%C3%A1lez-1080b5b6/', liType: 'linkedin' as const,
    img: '/images/ponentes_Nasly_Vidales.jpeg',
  },
  {
    name: 'Jhonatan Alexander Becerra Duitama', flag: '🇨🇴',
    ...
    li: 'https://www.linkedin.com/in/jhonatan-alexander-becerra-duitama/', liType: 'linkedin' as const,
    img: '/images/ponentes_Jhonatan_Alexander_Becerra.jpeg',
  },
  {
    name: 'William Fernando Bernal Suárez', flag: '🇨🇴',
    org: 'Fundación Universitaria Juan de Castellanos',
    rol: 'Líder Desarrollo Tecnológico',
    ponencia: 'Alianza Universidad Juan de Castellanos | Proyecto ABT.',
    li: 'https://www.linkedin.com/in/william-bernal-13457b60/', liType: 'linkedin' as const,
    img: '/images/ponentes_William_Fernando_Bernal.jpeg',
  },
  {
    name: 'Magda Lorena Pineda Rodríguez', flag: '🇨🇴',
    org: 'Fundación Universitaria Juan de Castellanos',
    rol: 'Líder Desarrollo Tecnológico',
    ponencia: 'Alianza Universidad Juan de Castellanos | Proyecto ABT.',
    li: 'https://www.linkedin.com/in/magda-pineda-rodriguez/', liType: 'linkedin' as const,
    img: '/images/ponentes_Magda_Lorena_Pineda.jpeg',
  },
  {
    name: 'John Cristhian Fernández Lizarazo', flag: '🇨🇴',
    org: 'Fundación Universitaria Juan de Castellanos',
    rol: 'Líder Desarrollo Tecnológico',
    ponencia: 'Alianza Universidad Juan de Castellanos | Proyecto ABT.',
    li: 'https://www.linkedin.com/in/john-cristhian-fernandez-lizarazo-a7230047/', liType: 'linkedin' as const,
    img: '/images/ponente_Cristhian_Utopía.jpeg',
  },
  {
    name: 'Santiago Granados Gutiérrez', flag: '🇨🇴',
    org: 'CEPAL-ONU',
    rol: 'Consultor',
    ponencia: 'Legados y desafíos de la COP16.',
    li: 'https://www.linkedin.com/in/santiago-granados-guti%C3%A9rrez-94a65a21/', liType: 'linkedin' as const,
    img: '/images/ponentes_Santiago_Granados.jpg',
  },
]
...
function PersonalidadesCarousel() {
  ...
  const onMouseDown = (e: React.MouseEvent) => {
    isDragging.current = true; startX.current = e.pageX; startScroll.current = trackRef.current?.scrollLeft ?? 0
  ...
  const onMouseMove = (e: React.MouseEvent) => {
    ...
    e.preventDefault(); trackRef.current.scrollLeft = startScroll.current - (e.pageX - startX.current)
  }
  ...
  const activeDot = trackRef.current
    ? Math.round(scrollPos / (trackRef.current.scrollWidth - trackRef.current.clientWidth) * (totalDots - 1))
    : 0
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div
        ...
        style={{
          display: 'flex', gap: 48, overflowX: 'auto', paddingBottom: 8,
          scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch',
          cursor: 'grab', userSelect: 'none', alignItems: 'stretch',
        }}
      >
        {PERSONALIDADES.map((p, i) => (
          ...
          >
            ...
            <div style={{ position: 'relative', width: 130, height: 130, marginBottom: 20, flexShrink: 0 }}>
              ...
              {/* social badge */}
              {p.liType === 'instagram' ? (
                <a href={p.li} target="_blank" rel="noopener noreferrer"
                  style={{ position: 'absolute', bottom: 4, right: 4, width: 28, height: 28, borderRadius: '50%', backgroundColor: '#E1306C', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.35)', border: '2px solid #09344e', textDecoration: 'none', transition: 'transform 0.15s' }}
                ...
                <a href={p.li} target="_blank" rel="noopener noreferrer"
                  style={{ position: 'absolute', bottom: 4, right: 4, width: 28, height: 28, borderRadius: '50%', backgroundColor: '#0A66C2', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.35)', border: '2px solid #09344e', textDecoration: 'none', transition: 'transform 0.15s' }}
                  onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.transform = 'scale(1.12)'}
                  onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.transform = 'scale(1)'}
                >
                  <IconLinkedin size={13} color="white" />
                </a>
              )}
            </div>

            {/* Nombre + flag */}
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', gap: 7, marginBottom: 6, width: '100%' }}>
              <span style={{ fontSize: 16, lineHeight: 1.4, flexShrink: 0, marginTop: 2 }}>{p.flag}</span>
              <span style={{ fontFamily: 'Poppins, sans-serif', fontSize: 13, fontWeight: 700, color: '#ffffff', textAlign: 'center', lineHeight: 1.3 }}>
                {p.name}
              </span>
            </div>

            {/* Org */}
            <p style={{ fontFamily: 'Poppins, sans-serif', fontSize: 11, fontWeight: 600, color: '#76E2CC', textAlign: 'center', lineHeight: 1.4, marginBottom: 5 }}>
              {p.org}
            </p>

            {/* Rol */}
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 11, color: 'rgba(255,255,255,0.50)', textAlign: 'center', lineHeight: 1.4, marginBottom: 14 }}>
              {p.rol}
            </p>
            ...
            {/* Ponencia */}
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 11, color: 'rgba(255,255,255,0.75)', textAlign: 'center', lineHeight: 1.6, flex: 1 }}>
              {p.ponencia}
            </p>
          </div>
        ))}
      ...
      {canPrev && (
        <button onClick={() => scrollTo(-1)} aria-label="Anterior"
          style={{ position: 'absolute', top: '40%', left: -22, transform: 'translateY(-50%)', width: 44, height: 44, borderRadius: '50%', backgroundColor: 'rgba(255,255,255,0.12)', border: '1.5px solid rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', zIndex: 3, transition: 'background-color 0.2s' }}
      ...
      {canNext && (
        <button onClick={() => scrollTo(1)} aria-label="Siguiente"
          style={{ position: 'absolute', top: '40%', right: -22, transform: 'translateY(-50%)', width: 44, height: 44, borderRadius: '50%', backgroundColor: 'rgba(255,255,255,0.12)', border: '1.5px solid rgba(255,255,255,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', zIndex: 3, transition: 'background-color 0.2s' }}
          onMouseEnter={e => (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'rgba(255,255,255,0.22)'}
          onMouseLeave={e => (e.currentTarget as HTMLButtonElement).style.backgroundColor = 'rgba(255,255,255,0.12)'}
        >
  ...
  return (
    <div style={{ backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'absolute', top: -80, right: -80, width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(0,74,59,0.30) 0%, transparent 70%)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', bottom: 40, left: -60, width: 300, height: 300, borderRadius: '50%', background: 'radial-gradient(circle, rgba(0,74,59,0.20) 0%, transparent 70%)', pointerEvents: 'none' }} />
        ...
        <div className="container-brand" style={{ padding: '0 48px 80px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }} className="hero-iceo-grid">
            ...
            >
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, backgroundColor: 'rgba(0,74,59,0.25)', border: '1px solid rgba(192,255,242,0.45)', borderRadius: 999, padding: '6px 16px', marginBottom: 20 }}>
                <span style={{ fontSize: 10, letterSpacing: '0.1em', fontWeight: 600, fontFamily: 'Poppins, sans-serif', color: '#C0FFF2', textTransform: 'uppercase' }}>
                  Edición 2024 · Cali, Colombia
                </span>
              </div>

              <h1 style={{ fontFamily: 'Gloock, Georgia, serif', fontSize: 'clamp(36px, 5vw, 60px)', fontWeight: 400, color: '#ffffff', lineHeight: 1.1, marginBottom: 20 }}>
                Memoria del<br />
                <span style={{ color: '#ffffff', fontWeight: 700 }}>2° ICEO</span>
              </h1>

              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 15, color: 'rgba(255,255,255,0.85)', lineHeight: 1.75, marginBottom: 32, maxWidth: 440 }}>
                Descubre el impacto que logramos en la segunda edición del congreso en 2024 y aprende más sobre este movimiento que transforma organizaciones ambientales en Latinoamérica.
              </p>
              ...
              <Link href="/docs/memoria_2iceo.pdf" target="_blank" style={{
                ...
                letterSpacing: '0.04em', boxShadow: '0 4px 20px rgba(0,0,0,0.25)',
                textTransform: 'uppercase', transition: 'background-color 0.2s, transform 0.15s',
              }}
            ...
            >
              <div style={{ position: 'absolute', top: -16, right: -16, width: '100%', height: '100%', border: '2px solid rgba(255,255,255,0.30)', borderRadius: 16, zIndex: 0 }} />
              <div style={{ position: 'relative', zIndex: 1, borderRadius: 14, overflow: 'hidden', aspectRatio: '16/10', boxShadow: '8px 8px 40px rgba(0,0,0,0.3)' }}>
                <img src="/icons/2do_iceo.svg" alt="2° ICEO LATAM" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section style={{ backgroundColor: '#09344e', padding: '80px 0' }}>
        <div className="container-brand" style={{ padding: '0 48px' }}>
          <FadeIn>
            <h2 style={{ fontFamily: 'Poppins, sans-serif', fontSize: 28, fontWeight: 600, color: '#fff', textAlign: 'center', marginBottom: 12 }}>
              Personalidades destacadas
            </h2>
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: 'rgba(255,255,255,0.40)', textAlign: 'center', marginBottom: 56, letterSpacing: '0.03em' }}>
              {PERSONALIDADES.length} ponentes · desliza para ver todos →
            </p>
          </FadeIn>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'start' }} className="voces-grid">
            <FadeIn>
              ...
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 15, color: '#5A6E77', lineHeight: 1.75, marginBottom: 16 }}>
                El 2° ICEO fue un espacio de encuentro entre organizaciones, comunidades, líderes y jóvenes que construyen soluciones desde sus territorios. Conoce tres de las más compartidas experiencias, saberes y alianzas que hizo posibles el congreso.
              </p>
              <blockquote style={{ borderLeft: '3px solid #03A383', paddingLeft: 18, margin: '24px 0', fontFamily: 'Inter, sans-serif', fontSize: 14, fontStyle: 'italic', color: '#5A6E77', lineHeight: 1.75 }}>
                "El 2° ICEO LATAM fue un espacio enriquecedor entre organizaciones ambientales y tecnológicas que movilizamos permanentemente."
              </blockquote>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 60, alignItems: 'center' }} className="relevancia-grid">
            <FadeIn>
              <div style={{ borderRadius: 14, overflow: 'hidden', aspectRatio: '4/3', boxShadow: '8px 8px 40px rgba(0,0,0,0.3)' }}>
                <img src="/icons/2do_iceo.svg" alt="Relevancia e Impacto 2° ICEO" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
              </div>
            </FadeIn>
            <FadeIn delay={0.15}>
        ...
        <FadeIn>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/docs/memoria_2iceo.pdf" target="_blank" style={{
              ...
              letterSpacing: '0.04em', textTransform: 'uppercase', boxShadow: '0 4px 20px rgba(0,0,0,0.15)',
            }}>
              ↓ Descargar memoria
            </Link>
            <Link href="/docs/memoria_2iceo.pdf" target="_blank" style={{
              ...
              fontFamily: 'Poppins, sans-serif', fontSize: 13, fontWeight: 700,
              padding: '11px 32px', borderRadius: 999, textDecoration: 'none',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }} className="donacion-grid">
            <FadeIn>
              ...
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 15, color: '#5A6E77', lineHeight: 1.75, marginBottom: 12 }}>
                Tu ayuda garantiza que organizaciones ambientales que no cuentan con recursos puedan asistir al 2° ICEO y formar parte de un espacio de aprendizaje, colaboración y transformación climática.
              </p>
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, color: '#5A6E77', lineHeight: 1.6, marginBottom: 28, opacity: 0.8 }}>
                El importe irá íntegramente destinado a cubrir alojamiento, manutención, transporte y tasas.
              </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }} className="follow-grid">
            <FadeIn>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <img src="/icons/follow.svg" alt="Follow us on social media" style={{ width: '100%', maxWidth: 380, height: 'auto', display: 'block' }} />
              </div>
            </FadeIn>
            <FadeIn delay={0.15}>
