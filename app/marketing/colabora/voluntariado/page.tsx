      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#E6F3EE', paddingTop: 80 }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 24 }}>
            <img src="https://pub-94aa83314f8a41088bff3c1130d43ebd.r2.dev/3ICEO/ui/drop-hands.svg" alt="Postulación recibida" style={{ width: 100, height: 100, objectFit: 'contain' }} />
          </div>
