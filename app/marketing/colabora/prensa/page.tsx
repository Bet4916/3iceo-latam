...
const TIPOS_COLABORACION: string[] = [
  'Cobertura Periodística',
  'Entrevistas',
  'Difusión previa del congreso',   // se mapea a 'Difusion previa del congreso' en la route
  'Alianza de medios',
  'Creación de contenido',
  'Otros',
]

const TIPOS_MEDIO: string[] = [
  'Periódico / Diario',
  'Revista',
  'Portal web / Medio digital',
  'Radio',
  'Televisión',
  'Podcast',
  'Agencia de noticias',
  'Blog / Medio independiente',
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#E6F3EE', paddingTop: 80 }}>
        ...
        >
          ...
          <p style={{ fontFamily: 'Poppins, sans-serif', fontSize: 14, color: '#437287', marginBottom: 4 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 4 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div style={S.field}>
                  ...
                  <input
                    style={{ ...S.input, borderColor: errors.nombreMedio ? '#A7170C' : '#C3DED9' }}
                    type="text" placeholder="Nombre del medio"
                    value={form.nombreMedio} onChange={e => set('nombreMedio', e.target.value)}
                  />
                ...
                <div style={S.field}>
                  ...
                  <input
                    style={{ ...S.input, borderColor: errors.cargoRol ? '#A7170C' : '#C3DED9' }}
                    type="text" placeholder="Ej: Periodista ambiental"
                    value={form.cargoRol} onChange={e => set('cargoRol', e.target.value)}
                  />
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                <div style={S.field}>
                  ...
                  <select
                    style={{ ...S.select, borderColor: errors.tipoMedio ? '#A7170C' : '#C3DED9' }}
                    value={form.tipoMedio} onChange={e => set('tipoMedio', e.target.value)}
                  >
                ...
                <div style={S.field}>
                  ...
                  <select
                    style={{ ...S.select, borderColor: errors.tipoColaboracion ? '#A7170C' : '#C3DED9' }}
                    value={form.tipoColaboracion} onChange={e => set('tipoColaboracion', e.target.value)}
                  >
                    <option value="">Selecciona el tipo</option>
              ...
              <div style={S.field}>
                ...
                <select
                  style={{ ...S.select, borderColor: errors.diasCobertura ? '#A7170C' : '#C3DED9' }}
                  value={form.diasCobertura} onChange={e => set('diasCobertura', e.target.value)}
                >
